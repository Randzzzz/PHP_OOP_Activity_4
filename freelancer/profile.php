          ...
          <div class="card shadow mt-4 mb-4">
            <div class="card-body">
              <div class="row">
                <div class="col-md-6">
                  <?php
                    $profilePic = !empty($userInfo['display_picture'])
                      ? 'profile_uploads/' . $userInfo['display_picture']
                      : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png';
                  ?>
                  <img src="<?php echo $profilePic; ?>" class="img-fluid mt-4 mb-4" alt="Profile Picture">
